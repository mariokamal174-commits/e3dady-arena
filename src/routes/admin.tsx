                ...
                <div>
                  ...
                  <div className="mt-2 flex flex-wrap gap-2">
                    {[
                      ...
                      { key: "الكتاب المقدس — العهد القديم", label: "العهد القديم" },
                      { key: "الكتاب المقدس — العهد الجديد", label: "العهد الجديد" },
                      { key: "تاريخ الكنيسة والقديسين", label: "تاريخ الكنيسة" },
                      { key: "عام", label: "عام" },
                      { key: "ألغاز", label: "ألغاز" },
                      { key: "رياضة", label: "رياضة" },
                      { key: "تاريخ", label: "تاريخ" },
                      { key: "جغرافيا", label: "جغرافيا" },
                      { key: "علوم", label: "علوم" },
                      { key: "فضاء وكون", label: "فضاء" },
                      { key: "حيوانات وطبيعة", label: "طبيعة" },
                      { key: "أدب عربي وشعر", label: "أدب عربي" },
                      { key: "شخصيات مشهورة", label: "شخصيات" },
                      { key: "أفلام ومسلسلات", label: "أفلام" },
                      { key: "تكنولوجيا", label: "تكنولوجيا" },
                      { key: "أمثال وحكم عربية", label: "أمثال وحكم" },
                      { key: "تاريخ مصر والفراعنة", label: "تاريخ مصر" },
                      { key: "عواصم ودول العالم", label: "دول وعواصم" },
                      { key: "رياضة — كرة قدم", label: "كرة قدم" },
                    ].map((c) => (
                      <button
                        key={c.key}
                        type="button"
